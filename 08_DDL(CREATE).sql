...
-- DML(Data Manipulation Langage) : 데이터 조작 언어, 테이블에 데이터를 삽입, 수정, 삭제하는 언어
-- TCL(Transaction Control Langage) : 트랜잭션 제어 언어, DML 수행 내용을 COMMIT, ROLLBACK 하는 언어
...
CREATE TABLE MEMBER(
	...
	MEMBER_SSN CHAR(14), -- 970801-1002111
...
INSERT INTO "MEMBER" VALUES('MEM01', '123ABC', '홍길동', '970801-1002111', DEFAULT);
																		--SYSDATE
...
-- 추가 샘플 데이터 삽입
-- 가입일 -> SYSDATE를 활용
INSERT INTO "MEMBER" VALUES('MEM02', '12GEWF', '김영희', '968711-3025415', SYSDATE);


-- 가입일 -> DEFAULT 활용(테이블 생성 시 정의된 값이 반영됨)
INSERT INTO "MEMBER" VALUES('MEM03', '51FDW8', '박철수', '970801-564811', DEFAULT);
...
VALUES('MEM04', '1FDA152', '이지연');

-- ** JDBC에서 날짜를 입력 받았을 때 삽입하는 방법 **
-- '2022-09-13 17:33:27'
INSERT INTO "MEMBER" VALUES('MEM05', 'PASS05', '김길동', '854120-2564781',
...
INSERT INTO MEMBER2 VALUES('MEM02', 'PASS02', '김길동', 0045678901);
...
-- ORA-01400: NULL을 ("KH_SAM"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다.
...
CREATE TABLE USER_USED_FK(
  ...
  -- 테이블 레벨
--  , CONSTRAINT GRADE_CODE_FK FOREIGN KEY(GRADE_CODE) REFERANCES USER_GRADE
...
-- ** CHECK 제약 조건은 범위로도 FK 제약조건의 하위 호환이다!
--> 둘다 컬럼의 값을 지정된 형태로만 제한을 하지마니
...
--> 서브쿼리로 테이블 생성 시
--  테이블의 형태(컬럼명, 데이터 타입)만 복사되고 + NOT NULL 제약조건만 복사!
